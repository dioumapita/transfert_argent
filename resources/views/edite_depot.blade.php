    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-9" style="display: flex; justify-content: right;">
          <h1>ESPACE MODIFICATION DEPOT SADIBO TRANSFERT</h1>
        </div>
        <div class="col-sm-3">
      ...
      <div class="row" style="display: flex; justify-content: center;">
        <div class="col-md-6">
          <div class="card card-success">
            ...
            @endif
            <form id="quickForm" method="post" action="{{route('update_depot',$depot->id)}}">
              @csrf
              {{ method_field('PUT')}}
              ...
              <!-- left column -->
                <div class="card-body col-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="montant_dep" value="{{$depot->montant_dep}}" class="form-control" id="" placeholder="Prenom receveur">
                  </div>
                  <div class="form-group">
                    <label for="">Commission</label>
                    <input type="text" name="commission_dep" value="{{$depot->commission_dep}}" class="form-control" id="" placeholder="Prenom receveur">
                  </div>
                  <div class="form-group">
