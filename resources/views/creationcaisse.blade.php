    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-9" style="display: flex; justify-content: right;">
          <h1>ESPACE CREATION CAISSE SADIBO TRANSFERT</h1>
        </div>
        <div class="col-sm-3">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a class="btn btn-primary" href="{{route('accueil')}}">Accueil</a></li>
            <li class="breadcrumb-item active"><a class="btn btn-primary" href="{{route('listecaisse')}}">Afficher Caisse</a></li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row" style="display: flex; justify-content: center;">
        <div class="col-md-6">
          <div class="card card-success">
            ...
            <h2 class="text-center">Saisir les infromations de la caisse</h2>
            </div>
            @if ($errors->any())
            ...
            @endif
            <form id="quickForm" method="post" action="{{route('caisse.ajouter')}}" novalidate="novalidate" >
              @csrf
              ...
              <div class="card-body col-12">
                  ...
                  <div class="form-group">
                    <label for="">Adresset</label>
                    <input type="text" name="adresse_caisse" class="form-control" id="" placeholder="Adresse caisse">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="hidden" name="total_dep_caisse" value="0" readonly="readonly"  class="form-control" id="" placeholder="">
                  </div>
                  <div class="form-group">
                    <input type="hidden" name="total_ret_caisse" value="0" readonly="readonly"  class="form-control" id="" placeholder="">
                  </div>
                  <div class="form-group">
                    <input type="hidden" name="montant_benefice_depot" value="0" readonly="readonly"  class="form-control" id="" placeholder="">
                  </div>
                  <div class="form-group">
